...
export default function EmploisPage() {
  ...
  const filtered = filter === "tous" ? offres : offres.filter(o => o.domaine === filter);
        ...
        <div className="container relative z-10 mx-auto px-6 md:px-8 max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white/50 text-xs uppercase tracking-widest">Missions & Emplois · Festival Evala</span>
            </div>
            ...
            <p className="text-white/50 text-base max-w-xl mb-8">
              Missions ponctuelles, prestations et bénévolat — toutes les opportunités de travail pendant le festival Evala à Kara.
            </p>
            <Link
        ...
        >
          {FILTERS.map(f => (
            <button
              ...
              style={filter === f.id
                ? { background: "#CE1126", color: "white", borderColor: "#CE1126" }
        ...
        {isLoading ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            ...
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center"
              style={{ background: "rgba(206,17,38,0.07)", border: "1px solid rgba(206,17,38,0.15)" }}>
              <Briefcase className="w-6 h-6" style={{ color: "#CE1126" }} />
            </div>
            <p className="text-black/45 text-sm">Aucune offre disponible pour l'instant.</p>
